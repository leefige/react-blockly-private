		...
		var BlocklyEditor = React.createClass({
			...
			render: function render() {
				...
				return React.createElement(
					...
					React.createElement(_BlocklyToolbox2.default, {
					...
					React.createElement(_BlocklyWorkspace2.default, {
						ref: 'workspace',
			...
			renderCategories: function renderCategories(categories) {
				return categories.map(function (category, i) {
					if (category.get('type') === 'sep') {
						...
						return React.createElement(_BlocklyToolboxCategory2.default, {
		...
		var BlocklyToolboxBlock = React.createClass({
			...
			statics: {
				renderBlock: function renderBlock(block, key) {
					return React.createElement(BlocklyToolboxBlock, {
						type: block.get('type'),
						key: key,
		...
		var BlocklyWorkspace = React.createClass({
			...
			render: function render() {
				...
				if (this.props.toolboxMode === "CATEGORIES") {
					dummyToolboxContent = React.createElement('category', {
						name: 'Dummy toolbox'
					});
				}
